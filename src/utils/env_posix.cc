...
#include "portable/port.h"
#include "portable/atomic_pointer.h"
...
Counter posix_read_size_counter;
Counter posix_write_size_counter;

Counter posix_read_counter;
Counter posix_write_counter;
Counter posix_sync_counter;
Counter posix_list_counter;
Counter posix_exists_counter;
Counter posix_open_counter;
Counter posix_close_counter;
Counter posix_delete_counter;
Counter posix_tell_counter;
Counter posix_seek_counter;
Counter posix_info_counter;
Counter posix_other_counter;
...
static void InitPosixEnv() {
    posix_env = new PosixEnv;
}

Env* EnvPosix() {
  pthread_once(&once, InitPosixEnv);
  return posix_env;
}
